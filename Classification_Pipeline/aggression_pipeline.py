...
# download annotated comments and annotations for aggression dataset:
...
download_file(ANNOTATED_COMMENTS_URL, 'aggression_annotated_comments.tsv')
download_file(ANNOTATIONS_URL, 'aggression_annotations.tsv')
